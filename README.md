...
Касательно остальных параметров, они были в пределах нормы и не сильно изменялись при подрезании реплик.
...
Во-первых, можно сказать, что число пересечений относительно небольшое (особенно для второй реплики). Связано это в первую очередь с низким числом пиков у реплик (выравнивание происходило только на 14 хромосому).
